...
class Layout {
	...
	public function htmlMain(){
		...
		<div class="description">
			...
			<span>
			'. __('Tail DMP is the right platform for publishers: we help portals, sites and blogs to find out Audience Segments over your media inventory in real time, making it possible to deliver the most relevant advertising and content.' , $settings->slug) .'
			</span>
