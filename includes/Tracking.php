 ...
 * @author Tail <tecnologia@tail.digital>
 * @version 1.0
 */
...
class trackingTailTarget{
	...
	public function add_plugin_page() {
		...
		add_options_page('Tail DMP Configuration Plugin', 'Tail DMP', 'manage_options', 'tt-setting-admin', array($this, 'create_admin_page'));
